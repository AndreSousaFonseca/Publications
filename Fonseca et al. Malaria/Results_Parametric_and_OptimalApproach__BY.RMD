---
title: "Results_Parametric_and_OptimalApproach_BY.final.version"
author: "Andre"
date: '2022-06-15'
output:
  html_document:
...
#    
#  }else{
#    output<- rbind(output,c('SkewNormal', 1 ,999,999,0))
#  }
#  sn.l <-c ()
#  
...
# Work on the 2 sub-populations Mixture-models. Here we are using the Chi-square test to achieve the optimal cutpoint
```{r}
...
#write.csv(colnames(x_train), "par_abs.csv")
...
library.pred <-  sl$library.predict
